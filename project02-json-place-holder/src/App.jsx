...
const ListTop = (props) => {
  ...
  for(var i = 0; i < myList.length; i++){
    ...
    listTag.push(
      <tr key={data.id}>
        <td><img src='/public/favicon.ico' alt='{data.title}'
          width='80px' /></td>
  ...
  return(
    <div id='contactList'>
      <table boarder='1' className='table table-bordered table-striped'>
...
const ContentBody = (props) => {
  return(
    <div id='contactView'>
      ...
      <ul className='llist-group list-group-flush list-hover'>
        ...
        <li className='list-group-item list-group-item-action'>
          thumbnailUrl : <img src="public/logo192.png" alt='{props.myResult.title}' className='myImg' /></li>
      </ul>
    </div>
  );
}
