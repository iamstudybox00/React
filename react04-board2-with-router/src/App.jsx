  ...
  return (
    <div className='App'>
        <Routes>
          ...
          <Route path='/view'> 
            <Route path=':no' element={<View boardData={boardData} setBoardData={setBoardData} navigate={navigate}></View>} />
          </Route>
          ...
          <Route path='/edit'>
            <Route path=':no' element={<Edit boardData={boardData} 
              setBoardData={setBoardData} navigate={navigate} nowDate={nowDate} />} />
          </Route>
          <Route path='*' element={<NotFound />} />
        </Routes>
    </div>
